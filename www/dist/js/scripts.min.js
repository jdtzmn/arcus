...
var watching,servers={get:function(){var e=JSON.parse(window.localStorage.getItem("servers"))||[];return e},add:function(e,t){validToken&&auth0.add(e,t,function(){auth0.get(function(e){window.localStorage.setItem("servers",JSON.stringify(e.body.servers)),servers.render()})});var r=servers.get();return r.push({name:e,ip:t}),window.localStorage.setItem("servers",JSON.stringify(r)),r},remove:function(e){validToken&&auth0.remove(e,function(){auth0.get(function(e){window.localStorage.setItem("servers",JSON.stringify(e.body.servers)),servers.render()})});var t=servers.get();if("string"==typeof e){for(var r=0;r<t.length;r++)if(t[r].name===e)return t.splice(r,1),window.localStorage.setItem("servers",JSON.stringify(t)),t}else if("number"==typeof e)return t.splice(e,1),window.localStorage.setItem("servers",JSON.stringify(t)),t},render:function(){servers.get().length>0?($(".nothing").hide(),$(".data").fadeIn(),$(".servers").hide().render(servers.get(),{cancel:{style:function(){return"display: none"}}}).fadeIn()):0===servers.get().length&&($(".data").hide(),$(".nothing").fadeIn()),servers.watch()},watch:function(){mcstatus(servers.get(),function(e){e instanceof Error?console.log(e):servers.notify(e)}),clearInterval(watching),watching=setInterval(function(){mcstatus(servers.get(),function(e){e instanceof Error?console.log(e):servers.notify(e)})},5e3)},notify:function(e){if(PNotify.prototype.options.styling="fontawesome",PNotify.desktop.permission(),validToken){var t=new Date,r="["+(t.getMonth()+1)+"/"+t.getDate()+"/"+t.getFullYear()+" @ "+t.getHours()+":"+t.getMinutes()+":"+t.getSeconds()+"]%0a ";$.ajax({url:"/api/notify?msg="+r+e,beforeSend:function(e){e.setRequestHeader("Authorization","Bearer "+localStorage.getItem("userToken"))}}).done(function(t){new PNotify({title:"Arcus",text:e,type:"info",icon:!1,mouse_reset:!1,desktop:{desktop:!0,icon:!1},mobile:{swipe_dismiss:!0,styling:!0}})})}else new PNotify({title:"Arcus",text:e,type:"info",icon:!1,mouse_reset:!1,desktop:{desktop:!0,icon:!1},mobile:{swipe_dismiss:!0,styling:!0}})}};
